...
namespace EMPIMS.Module.IndexManage
{
    ...
    public class EMPI_PERSON_SBR
    {
        ...
        public void Create()
        {
            this.PERSON_SBR_ID = Guid.NewGuid().ToString();
            //this.EMPI_ID = Common.CreateNo();
            //this.CREATE_BY = OperatorProvider.Provider.GetCurrent().UserName;
            this.CREATE_TIME = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            //this.IP_MEDICAL_RECORD_NO = Common.GetIP() + "_" + Common.getMNum();
        }
    }
}
